...
#include<ctime>
#include<vector>
#include "minHeap.h" //You need to implement this.
...
int main()
{
    ...
    minHeap h(numbers.size());// Passing the maximum size of the heap as parameter to constructor. You need to implement this.
//    Heap h(numbers); // You need to implement this constructor too and construct the heap from the provided vector
    ...
    // Now, "numbers" vector contains the numbers in ascending order
